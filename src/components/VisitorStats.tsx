...
export default function VisitorStats() {
  ...
  return (
    <div className="p-4 mt-8 max-w-sm mx-auto rounded-xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm flex flex-col items-center justify-center space-y-2 transition-colors">
      ...
      <p className="text-gray-600 dark:text-gray-300 text-sm flex items-center text-center">
      ...
      <p className="text-gray-600 dark:text-gray-300 text-sm text-center">
        ...
        <span className="font-extrabold text-blue-600 dark:text-blue-400 text-lg inline-block w-[45px] text-center ml-1">
          <CountUp start={0} end={count} duration={10} separator="." />
        </span>{' '}
        Mal besucht.
      </p>
    </div>
